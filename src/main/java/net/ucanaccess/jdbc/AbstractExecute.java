...
public abstract class AbstractExecute {
    ...
    protected AbstractExecute(UcanaccessResultSet resultSet) {
        this(resultSet.getWrappedStatement(), CommandType.UPDATABLE_RESULTSET, null, 0, null, null);
        this.resultSet = resultSet;
    }

    protected AbstractExecute(UcanaccessStatement statement, CommandType commandType,
        String sql, int autoGeneratedKeys, String[] columnNames, int[] indexes) {
    ...
    protected AbstractExecute(UcanaccessStatement statement) {
        this.statement = statement;
    }

    private Object enableDisable(DDLType ddlType) throws SQLException, IOException {
        String tableName = Objects.requireNonNull(ddlType.getDBObjectName());
