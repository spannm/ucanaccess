...
public class UcanaccessConnection implements Connection {
	...
	public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys)
		...
		try {
			sql = prepare(sql);
			return new UcanaccessPreparedStatement(sql,
					hsqlDBConnection.prepareStatement(preprocess(sql), autoGeneratedKeys),
					this);
		} catch (SQLException e) {
			throw new UcanaccessSQLException(e);
		}
	...
	public PreparedStatement prepareStatement(String sql, int resultSetType,
		...
		try {
			sql = prepare(sql);
			return new UcanaccessPreparedStatement(sql,
					hsqlDBConnection.prepareStatement(preprocess(sql), resultSetType,
	...
	public PreparedStatement prepareStatement(String sql, int[] columnIndexes)
		...
		try {
			sql = prepare(sql);
			return new UcanaccessPreparedStatement(sql,
					hsqlDBConnection.prepareStatement(preprocess(sql), columnIndexes), this);
		} catch (SQLException e) {
			throw new UcanaccessSQLException(e);
		}
	}
	...
	public PreparedStatement prepareStatement(String sql, String[] columnNames)
		...
		try { 
			sql = prepare(sql);
			return new UcanaccessPreparedStatement(sql,
					hsqlDBConnection.prepareStatement(preprocess(sql), columnNames), this);
		} catch (SQLException e) {
			throw new UcanaccessSQLException(e);
		}
	}
