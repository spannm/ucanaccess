...
public class ReloadPersistentMirrorTest extends UcanaccessTestBase {
    ...
    public void testReloadMirror() throws Exception {
        ...
        try {
            ...
            // create the database
            String urlCreate = UcanaccessDriver.URL_PREFIX + dbFile.getAbsolutePath() + ";memory=true"
            ...
            String urlMirror = UcanaccessDriver.URL_PREFIX + dbFile.getAbsolutePath() + ";keepMirror="
                    + mirrorFile.getAbsolutePath() + ";immediatelyReleaseResources=true";
