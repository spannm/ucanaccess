...
public class ComplexTest extends UcanaccessTestBase {
    ...
    private void complex0() throws SQLException, IOException, ParseException {
        ...
        try {
            ...
            ps = super.ucanaccess
                    .prepareStatement("select count(*) from TABLE1 WHERE  EQUALSIGNOREORDER([MULTI-VALUE-DATA],?)");
            ps.setObject(1, SingleValue.multipleValue("value4", "value1"));
            rs = ps.executeQuery();
            rs.next();
            assertEquals(1, rs.getInt(1));
    ...
    public void testComplexRoolback() throws SQLException, IOException, ParseException, SecurityException,
