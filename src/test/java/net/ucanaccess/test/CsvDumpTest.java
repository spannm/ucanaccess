...
public class CsvDumpTest extends UcanaccessTestBase {
	...
	private static final String CREATE_CSV_TABLE = "CREATE TABLE csvtable ("
			+ "id INTEGER, "
			+ "text_field TEXT, "
			+ "text_field2 TEXT, "
			+ "memo_field MEMO, "
	...
	private static final String INSERT_CSV_TABLE = "INSERT INTO csvtable ("
			+ "id, "
			+ "text_field, "
			+ "text_field2, "
			+ "memo_field, "
	...
	private static final String EXPECTED_SCHEMA = 
			...
			+ String.format(FORMAT, "date_field", "timestamp", "nullable") + LINE_SEPARATOR
			+ "]" + LINE_SEPARATOR;
