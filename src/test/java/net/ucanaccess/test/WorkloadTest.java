...
public class WorkloadTest extends UcanaccessTestBase {
    ...
    public void testLoad30000() throws SQLException, IOException, InterruptedException {
        ...
        try {
            ...
            System.out.println(
                    "Autoincrement insert performance test, 30000 records inserted in " + (time1 - time) + " seconds");
            st = super.ucanaccess.createStatement();
            st.executeUpdate("update aaAB set c='yessssss'&a");
            super.ucanaccess.commit();
            long time2 = System.currentTimeMillis();
            System.out.println(
                    "Update performance test, all 30000 table records updated in " + (time2 - time1) + " seconds");
